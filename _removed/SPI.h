...
#define SPI_CLOCK_DIV2 0x0A    // 8MHz
#define SPI_CLOCK_DIV4 0x15    // 4MHz
#define SPI_CLOCK_DIV8 0x2A    // 2MHz
#define SPI_CLOCK_DIV16 0x54   // 1MHz
#define SPI_CLOCK_DIV32 0xA8   // 500KHz
#define SPI_CLOCK_DIV64 0xFF   // 329411Hz
